...
$GLOBALS['TL_LANG']['tl_poll']['jumpId']                    = array('Jump id', 'The id to jump to.');
...
$GLOBALS['TL_LANG']['tl_poll']['behaviorVoted']['opt1']    = 'Show results immedietaly';
...
$GLOBALS['TL_LANG']['tl_poll']['editheader'] = array('Edit poll settings', 'Edit the settings of poll ID %s');
